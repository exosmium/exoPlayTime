...
public class RunCmdChannelListener implements Consumer<ReceivedMessage>, Registerable {
    ...
    private final SockExchangeVelocity plugin;
    private final Logger basicLogger;
    private final SockExchangeApi api;
    private final CommandManager commandManager;

    RunCmdChannelListener(SockExchangeVelocity plugin, Logger basicLogger, SockExchangeApi api, CommandManager commandManager) {
