...
public class MoveOtherToCommand implements TabExecutor, Registerable
{
  ...
  private final SockExchangeSpigot plugin;
  private final SpigotPlugin spigotPlugin;
  private final MessageFormatMap formatMap;
  private final SockExchangeApi api;

  MoveOtherToCommand(SockExchangeSpigot plugin, SpigotPlugin spigotPlugin, MessageFormatMap formatMap, SockExchangeApi api)
  {
  ...
  {
    spigotPlugin.getCommand(COMMAND_NAME).setExecutor(this);
  }

  @Override
  public void unregister()
  {
    spigotPlugin.getCommand(COMMAND_NAME).setExecutor(null);
  }
  ...
  public boolean onCommand(CommandSender sender, Command command, String s, String[] args)
  {
    ...
    {
      for (Player player : spigotPlugin.getServer().getOnlinePlayers())
      {
