...
public class RunCmdCommand implements CommandExecutor, Registerable
{
  ...
  RunCmdCommand(SpigotPlugin spigotPlugin, RunCmdChannelListener runCmdChannelListener, MessageFormatMap formatMap, SockExchangeApi api) {
    Preconditions.checkNotNull(spigotPlugin, "plugin");
